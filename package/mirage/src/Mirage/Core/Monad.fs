...
/// <summary>
/// Run the <b>Async</b> on the current thread, cancelling the program when the token is cancelled.
/// This operation is **non-blocking**.
/// </summary>
let runImmediate<'A> (token: CancellationToken) (program: Async<Unit>) : Unit =
    Async.StartImmediate(program, token)
