                ...
                match input with
                    ...
                    | TranscribeRecording action ->
                        match action with
                            | RecordStart _ ->
                                sampleBuffer.Clear()
                                do! onTranscribe <| TranscribeRecordingAction TranscribeRecordingStart
                            | RecordEnd payload ->
                                do! withLock' lock <| async {
                                    ...
                                    do! onTranscribe << TranscribeRecordingAction << TranscribeRecordingEnd <|
